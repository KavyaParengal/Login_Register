        ...
        body: Stack(
          children: <Widget>[
            ...
            isLoading
                ...
                : (_freeContent.length ?? 0) > 0
                    ? Container(
                        child: ListView.builder(
                          padding: const EdgeInsets.only(bottom: 100),
                          itemCount:
                          _freeContent.length ?? 0,
                          shrinkWrap: true,
                          itemBuilder: (context, index) {
                            FreeContentDataModel currFreeContentData =
                                _freeContent[index];
                            String videoId = YoutubePlayer.convertUrlToId(currFreeContentData.video.toString())!;
