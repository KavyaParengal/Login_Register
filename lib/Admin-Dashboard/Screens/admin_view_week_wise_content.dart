                ...
                Padding(
                  ...
                  child: RichText(text: TextSpan(children:[
                    TextSpan(text: "Description : ",style: TextStyle(
                        color: Colors.teal.shade700,fontWeight: FontWeight.bold, fontSize: 16)),
                    TextSpan(text: 'gdgsd hajhsk shjs jwhey and sdja djksl kfjh had hdbjs eurowla nsbjs',style: TextStyle(
                        color: Colors.black, fontWeight: FontWeight.w400, fontSize: 16))
                  ])),
                ),
                ...
                Padding(
                  ...
                  child: RichText(text: TextSpan(children:[
                    TextSpan(text: "Length : ",style: TextStyle(
                        color: Colors.teal.shade700,fontWeight: FontWeight.bold, fontSize: 16)),
                    TextSpan(text: '10 cm',style: TextStyle(
                        color: Colors.black, fontWeight: FontWeight.w400, fontSize: 16)
                    )
                  ])),
                ),
                ...
                Padding(
                  ...
                  child: RichText(text: TextSpan(children:[
                    TextSpan(text: "Weight : ",style: TextStyle(
                        color: Colors.teal.shade700,fontWeight: FontWeight.bold, fontSize: 16)),
                    TextSpan(text: '10 gm',style: TextStyle(
                        color: Colors.black, fontWeight: FontWeight.w400, fontSize: 16)
                    )
                  ])),
                ),
